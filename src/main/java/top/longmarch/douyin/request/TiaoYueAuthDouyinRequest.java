...
public class TiaoYueAuthDouyinRequest extends AuthDouyinRequest {
    ...
    public String authorize(String state) {
        return UrlBuilder.fromBaseUrl(source.authorize())
                ...
                .queryParam("scope", "user_info,video.create,video.delete,video.data,video.list,following.list,fans.list,hotsearch,fans.data,data.external.user,data.external.item,star_top_score_display,star_tops,star_author_score_display")
