...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RenrenScheduler', 'DESKTOP-A72KG941610103619525', 1610106319152, 15000);
...
CREATE TABLE `sys_permission`  (
  ...
  `type` tinyint(1) NULL DEFAULT NULL COMMENT '权限类型，菜单 1，按钮 2',
  ...
  `cache` tinyint(1) NULL DEFAULT NULL COMMENT '是否缓存',
...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1, 0, 'NaN', '系统管理', '系统管理', 'sys:manage', 1, 1, '/system', 'Layout', '/system/user', 'System', 'system', 'component', 0, 1, 1, 1, '2020-02-10 18:20:46', 1, '2021-01-08 19:36:45');
INSERT INTO `sys_permission` VALUES (2, 1, '1', '用户管理', '用户管理', 'sys:user:manage', 1, 1, 'user', 'user/index', NULL, 'UserManage', 'userManage', 'user', 0, 1, 1, 1, '2020-02-10 18:20:46', 1, '2021-01-07 19:40:57');
INSERT INTO `sys_permission` VALUES (3, 2, '1,2', '查看用户', '查看用户', 'sys:user:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:46', NULL, NULL);
INSERT INTO `sys_permission` VALUES (4, 2, '1,2', '添加用户', '查看用户', 'sys:user:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:46', NULL, NULL);
INSERT INTO `sys_permission` VALUES (5, 2, '1,2', '修改用户', '修改用户', 'sys:user:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:46', NULL, NULL);
INSERT INTO `sys_permission` VALUES (6, 2, '1,2', '删除用户', '删除用户', 'sys:user:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:46', NULL, NULL);
INSERT INTO `sys_permission` VALUES (7, 2, '1,2', '修改密码', '修改密码', 'sys:user:change:password', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:46', NULL, NULL);
INSERT INTO `sys_permission` VALUES (8, 1, '1', '角色管理', '角色管理', 'sys:role:manage', 1, 1, 'role', 'role/index', NULL, 'RoleManage', 'roleManage', 'peoples', 0, 1, 10, 1, '2020-02-10 18:20:46', 1, '2021-01-07 19:41:17');
INSERT INTO `sys_permission` VALUES (9, 8, '1,8', '查看角色', '查看角色', 'sys:role:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (10, 8, '1,8', '添加角色', '查看角色', 'sys:role:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (11, 8, '1,8', '修改角色', '修改角色', 'sys:role:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (12, 8, '1,8', '删除角色', '删除角色', 'sys:role:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (13, 1, '1', '权限管理', '权限管理', 'sys:permission:manage', 1, 1, 'permission', 'permission/index', NULL, 'PermissionManage', 'permissionManage', 'lock', 0, 1, 20, 1, '2020-02-10 18:20:47', 1, '2021-01-07 19:41:30');
INSERT INTO `sys_permission` VALUES (14, 13, '1,13', '查看权限', '查看权限', 'sys:permission:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (15, 13, '1,13', '添加权限', '查看权限', 'sys:permission:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (16, 13, '1,13', '修改权限', '修改权限', 'sys:permission:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (17, 13, '1,13', '删除权限', '删除权限', 'sys:permission:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (18, 1, '1', '部门管理', '部门管理', 'sys:department:manage', 1, 1, 'department', 'department/index', NULL, 'DepartmentManage', 'departmentManage', 'tree', 0, 1, 50, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:35:30');
INSERT INTO `sys_permission` VALUES (19, 18, '1,18', '查看部门', '查看部门', 'sys:department:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (20, 18, '1,18', '添加部门', '查看部门', 'sys:department:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (21, 18, '1,18', '修改部门', '修改部门', 'sys:department:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (22, 18, '1,18', '删除部门', '删除部门', 'sys:department:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (23, 1, '1', '字典管理', '字典管理', 'sys:dictionary:manage', 1, 1, 'dictionary', 'dictionary/index', NULL, 'DictionaryManage', 'dictionaryManage', 'dictionary', 0, 1, 60, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:34:14');
INSERT INTO `sys_permission` VALUES (24, 23, '1,23', '查看字典', '查看字典', 'sys:dictionary:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (25, 23, '1,23', '添加字典', '查看字典', 'sys:dictionary:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (26, 23, '1,23', '修改字典', '修改字典', 'sys:dictionary:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (27, 23, '1,23', '删除字典', '删除字典', 'sys:dictionary:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (28, 1, '1', '任务管理', '任务管理', 'sys:schedule:manage', 1, 1, 'schedule', 'job/schedule', NULL, 'ScheduleManage', 'scheduleManage', 'schedule', 0, 1, 80, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:33:42');
INSERT INTO `sys_permission` VALUES (29, 28, '1,28', '查看任务', '查看任务', 'job:schedule:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (30, 28, '1,28', '添加任务', '查看任务', 'sys:schedule:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (31, 28, '1,28', '修改任务', '修改任务', 'sys:schedule:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (32, 28, '1,28', '删除任务', '删除任务', 'sys:schedule:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (33, 28, '1,28', '执行任务', '执行任务', 'job:schedule:run', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (34, 28, '1,28', '暂停任务', '暂停任务', 'sys:schedule:pause', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (35, 28, '1,28', '恢复任务', '恢复任务', 'sys:schedule:resume', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (36, 28, '1,28', '重置任务', '重置任务', 'sys:schedule:reset', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (37, 28, '1,28', '任务日志', '任务日志', 'sys:schedule:log', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (38, 1, '1', '参数管理', '参数管理', 'sys:parameter:manage', 1, 1, 'parameter', 'parameter/index', NULL, 'ParameterManage', 'parameterManage', 'parameter', 0, 1, 100, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:32:31');
INSERT INTO `sys_permission` VALUES (39, 38, '1,38', '查看参数', '查看参数', 'sys:parameter:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (40, 38, '1,38', '修改参数', '修改参数', 'sys:parameter:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (41, 1, '1', '登录日志', '登录日志', 'sys:loginlog:manage', 1, 1, 'loginlog', 'log/loginLog', NULL, 'LoginLogManage', 'loginLogManage', 'login-log', 0, 1, 90, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:32:57');
INSERT INTO `sys_permission` VALUES (42, 41, '1,41', '查看日志', '查看日志', 'sys:loginlog:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (43, 1, '1', '操作日志', '操作日志', 'sys:operatelog:manage', 1, 1, 'operatelog', 'log/operateLog', NULL, 'OperateLogManage', 'operateLogManage', 'log', 0, 1, 70, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:33:58');
INSERT INTO `sys_permission` VALUES (44, 43, '1,43', '查看日志', '查看日志', 'sys:operatelog:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (45, 0, 'NaN', '内容管理', '内容管理', 'cms:manage', 1, 1, '/cms', 'Layout', '/cms/article', 'CmsManage', 'cmsManage', 'cms', 0, 1, 10, 1, '2020-02-10 18:20:47', 1, '2021-01-08 19:37:03');
INSERT INTO `sys_permission` VALUES (46, 45, '45', '文章管理', '文章管理', 'cms:article:manage', 1, 1, 'article', 'cms/article', NULL, 'ArticleManage', 'articleManage', 'user', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (47, 46, '45,46', '查看文章', '查看文章', 'cms:article:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (48, 46, '45,46', '添加文章', '查看文章', 'cms:article:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (49, 46, '45,46', '修改文章', '修改文章', 'cms:article:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (50, 46, '45,46', '删除文章', '删除文章', 'cms:article:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (51, 45, '45', '分类管理', '分类管理', 'cms:category:manage', 1, 1, 'category', 'cms/category', NULL, 'CategoryManage', 'categoryManage', 'user', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (52, 51, '45,51', '查看分类', '查看文章', 'cms:category:show', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (53, 51, '45,51', '添加分类', '添加分类', 'cms:category:create', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (54, 51, '45,51', '修改分类', '修改分类', 'cms:category:update', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
INSERT INTO `sys_permission` VALUES (55, 51, '45,51', '删除分类', '删除分类', 'cms:category:delete', 2, 1, NULL, NULL, NULL, NULL, NULL, 'button', 0, 1, 1, 1, '2020-02-10 18:20:47', NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'd89267ba6e888426c8f798a04f2fb874', NULL, 'http://upload.longmarch.top/FuemzbZAVn3PMbcBzrY6IfrtSf_r', '18888888888', 1, NULL, 12, '2021-01-08 11:01:10', NULL, NULL, 1, '2020-02-10 18:20:46', NULL, NULL);
